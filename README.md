...
> The pre-compiled binary files under [Releases](https://github.com/AlinaWan/pip-reroller/releases) are licensed under the [GNU GPLv3](/assets/GPLv3.LICENSE). [Learn more](binary_license_notice).
